    ...
    <ScrollView style={a.container}>
      <View style={a.box1}>
        ...
        <TouchableOpacity onPress={() => datepeople(1)} style={[a.contentbox, {backgroundColor: display[1] ? '#ddd' : 'white'}]}>
          ...
          <View style={a.content2}><Text style={{fontWeight: 'bold'}}>{location}</Text></View>
        </TouchableOpacity>
      </View>
      ...
      <View style={[a.box2, {display: display[1] ? 'flex' : 'none', height: 520}]}>
        <Location location={location} setLocation={setLocation} check={check} setCheck={setCheck} display={display} setDisplay={setDisplay}/>
      </View>
      <Text></Text>
    </ScrollView>
    </View>
